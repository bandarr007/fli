...
local ChengName = database:get(bot_id.."Cheng:Name"..data.id_)
if not data.first_name_ then 
if BChengName then 
send(msg.chat_id_, msg.id_, "يولد هذا غير اسمه لك ها كلب  ["..BChengName..']')
database:del(bot_id.."Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BChengName ~= data.first_name_ then 
local Text = {
  ' هاحبي شكو غيرت اسمك 🌞😹😹😹',
